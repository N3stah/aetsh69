...
INSERT INTO projects (title, slug, tagline, description, tech_stack, links, featured, sort_order, start_date, is_ongoing) VALUES
('SmartShamba', 'smartshamba', 'IoT-powered agriculture monitoring for small-scale farms.', 'SmartShamba is an end-to-end IoT platform that helps Kenyan smallholder farmers monitor soil moisture, weather patterns, and crop health via a mobile dashboard. Built with React, FastAPI, and ESP32 microcontrollers.', '["React", "FastAPI", "PostgreSQL", "ESP32", "MQTT"]', '{"github": "https://github.com/N3stah/smartshamba", "live": "https://smartshamba.aetsh69.com"}', TRUE, 1, '2024-01-15', TRUE),
('AETSH-69 Ecosystem', 'aetsh69-ecosystem', 'Personal tech ecosystem — portfolio, blog, shop, AI concierge, and more.', 'A full-stack personal platform built to showcase engineering work, sell services, and host an AI concierge. Features a dark-mode editorial design system, real-time chat, and Dockerized microservices.', '["React", "Tailwind", "FastAPI", "PostgreSQL", "Redis", "Docker"]', '{"github": "https://github.com/N3stah/personal-tech-ecosystem", "live": "https://aetsh69.com"}', TRUE, 2, '2024-03-01', TRUE),
('Nairobi CCTV Network', 'nairobi-cctv', 'City-wide surveillance network design and deployment.', 'Designed and deployed a 200-camera IP surveillance network across Nairobi commercial districts. Includes NVR setup, remote monitoring, and AI-powered motion detection alerts.', '["Hikvision", "Milestone", "Python", "OpenCV"]', '{"live": "https://cctv.aetsh69.com"}', FALSE, 3, '2023-06-01', FALSE),
('Chemsha Bongo', 'chemsha-bongo', 'Swahili word puzzle game with daily challenges.', 'A browser-based word puzzle game built for East African audiences. Features daily challenges, Swahili dictionary integration, and shareable score cards.', '["TypeScript", "Canvas API", "FastAPI", "Redis"]', '{"github": "https://github.com/N3stah/chemsha-bongo", "live": "https://chemsha.aetsh69.com"}', FALSE, 4, '2024-05-20', TRUE);
...
-- Seed Products
INSERT INTO products (name, slug, short_description, price_kes, price_usd, stock_quantity, is_featured, tags, category_id) VALUES
('SmartShamba Starter Kit', 'smartshamba-kit', 'Complete IoT kit for small-scale farm monitoring. Includes soil moisture sensor, weather station, and 6-month dashboard access.', 12500, 95, 50, TRUE, '["IoT", "Agriculture", "Kenya"]', (SELECT id FROM product_categories WHERE slug='hardware')),
('Consultation Hour', 'consultation-hour', 'One hour of dedicated technical consultation on any engineering challenge. Architecture review, debugging, or career advice.', 5000, 38, 999, FALSE, '["Consultation", "Engineering"]', (SELECT id FROM product_categories WHERE slug='services')),
('Nairobi CCTV Package', 'nairobi-cctv-package', '4-camera HD IP surveillance package with NVR, remote viewing setup, and 1-year support. Installation included within Nairobi.', 45000, 340, 20, TRUE, '["Security", "CCTV", "Nairobi"]', (SELECT id FROM product_categories WHERE slug='services')),
('AETSH-69 Source Code', 'aetsh69-source', 'Full source code access to the AETSH-69 ecosystem. React frontend, FastAPI backend, Docker compose, and documentation.', 15000, 115, 100, FALSE, '["Source Code", "React", "FastAPI"]', (SELECT id FROM product_categories WHERE slug='digital'));
