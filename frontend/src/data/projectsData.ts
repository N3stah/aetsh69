...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    description: 'Production agri-tech platform digitizing maize trading in Kenya. Synchronizes feature-phone farmers (USSD *384*53374#) with institutional buyers (Web) on a unified Supabase PostgreSQL database ledger.',
